 ...
 * @param offsetBytes offset from start of file
 * @param lengthBytes size of the partition
...
class S3Partition(var index: Int,
                  var offsetBytes: Long = 0, var lengthBytes: Long = 0,
  ...
  def getEnd(): Long = { offsetBytes + lengthBytes }
}
